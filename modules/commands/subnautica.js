...
module.exports.onLoad = async () => {
    ...
    if (!fs.existsSync(dir + "data.json")) (await axios({
        url: "https://raw.githubusercontent.com/PLViet/baucuagif/main/dataSubnautica.json",
        method: 'GET',
        responseType: 'stream'
    })).data.pipe(fs.createWriteStream(dir + "data.json"));

    if (!fs.existsSync(dir + "item.json")) (await axios({
        url: "https://raw.githubusercontent.com/PLViet/baucuagif/main/itemSubnautice.json",
        method: 'GET',
        responseType: 'stream'
...
module.exports.data = async function () {
    const data = (await axios.get(`https://raw.githubusercontent.com/PLViet/baucuagif/main/dataSubnautica.json`)).data;  
    return data
}
