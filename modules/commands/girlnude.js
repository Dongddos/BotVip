...
"https://i.imgur.com/QYGOZuK.jpg",
  ...
  var max = Math.floor(Math.random() * 90);  
  ...
  var money = data.money
   ...
   var callback = () => api.sendMessage({body:`Mấy ba khoái lắm😼\n» Số dư: -300 đô «\n📩Facebook.com/NealaPhung`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
