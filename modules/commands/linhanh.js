...
"https://i.postimg.cc/s28GcT4m/240996627-3018074361783520-1374492060414132441-n.jpg",
     ...
     var callback = () => api.sendMessage({body:`Yêu❤`,attachment: fs.createReadStream(__dirname + "/cache/linhanh.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/linhanh.jpg"));  
      return request(encodeURI(link[Math.floor(Math.random() * link.length)])).pipe(fs.createWriteStream(__dirname+"/cache/linhanh.jpg")).on("close",() => callback());
   };