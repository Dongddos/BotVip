...
module.exports.run = async ({ event, api, args, Users, getText }) => {
	...
	switch (type) {
     ...
     // if (event.senderID != 100044997840433) return api.sendMessage(`Ban cái l t nè`, event.threadID, event.messageID)
     ...
     // if (event.senderID != 100044997840433) return api.sendMessage(` Gỡ ban cái l t nè`, event.threadID, event.messageID)
