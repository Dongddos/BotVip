module.exports.config = {
    ...
    , module.exports.handleReply = async function({
        ...
        const n = global.nodemodule.axios
            ...
            , i = (global.nodemodule.request, await n.get("https://manhkhac.github.io/data/json/key_rapid.json"))
        ...
        try {
            ...
            const i = (await n.get(`${b}`, {
                ...
                .data;
            return s.writeFileSync(path1, Buffer.from(i, "utf-8")), e.unsendMessage(t.messageID), s.statSync(__dirname + "/cache/1.mp4")
                .size > 26e6 ? e.sendMessage("Không thể gửi file vì dung lượng lớn hơn 25MB.", a.threadID, (() => l(__dirname + "/cache/1.mp4")), a.messageID) : e.sendMessage({
                    body: `» ${y}`
        ...
        var u = ["AIzaSyDMNZtbgUAypH1YpKnLGWrHZN4RPiXFUlA"];
        ...
        if (0 == t.join(" ")
            ...
            const i = (await n.get(`${I}`, {
                ...
                .data;
            return s.writeFileSync(path1, Buffer.from(i, "utf-8")), s.statSync(__dirname + "/cache/1.mp4")
                .size > 26e6 ? e.sendMessage("Không thể gửi file vì nó có dung lượng lớn hơn 25MB.", a.threadID, (() => h(__dirname + "/cache/1.mp4")), a.messageID) : e.sendMessage({
                    body: `» ${v}`
                    , attachment: s.createReadStream(__dirname + "/cache/1.mp4")
                }, a.threadID, (() => s.unlinkSync(__dirname + "/cache/1.mp4")), a.messageID)
        }
