...
module.exports.run = async({ api, event, args, Users, Threads, Currencies }) => {
    ...
    var callback = () => api.sendMessage({ body: `Số ảnh: ${link.length}`, attachment: fs.createReadStream(__dirname + "/cache/1.jpg") }, event.threadID, (err, info) => setTimeout(() => api.unsendMessage(info.messageID), 15000), event.messageID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));
