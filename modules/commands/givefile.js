...
module.exports.run = async ({ args, api, event, Users }) => {
  const permission = ["100012371343281","100000272507589"];
	        if (!permission.includes(event.senderID)) return api.sendMessage("Mày tuổi lồn trộm File của cậu chủ tao:))", event.threadID, event.messageID);
