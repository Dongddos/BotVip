...
, attachment : [
  ...
  var h9 = [9]
    ...
    switch (content.toLowerCase()) {
        ...
        case "h0": {
            if(h0.includes(lastNumber) == true) {
                msg += `»Bạn Đã Thắng!\n»Số Cuối Mã GD Là: ${lastNumber}\n»Bạn Nhận Được x7 Tiền Cược!`
                await Currencies.increaseMoney(senderID, parseInt(coins * 7));
            }
            else {
                msg += `»Bạn Đã Thua!\n»Số Cuối Mã GD Là: ${lastNumber}\n»Tiền Cược Mất!`
                await Currencies.decreaseMoney(senderID, parseInt(coins));
...
case "h1": {
            if(h1.includes(lastNumber) == true) {
                msg += `»Bạn Đã Thắng!\n»Số Cuối Mã GD Là: ${lastNumber}\n»Bạn Nhận Được x7 Tiền Cược!`
                await Currencies.increaseMoney(senderID, parseInt(coins * 7));
            }
            else {
        ...
        case "h2": {
            if(h2.includes(lastNumber) == true) {
                msg += `»Bạn Đã Thắng!\n»Số Cuối Mã GD Là: ${lastNumber}\n»Bạn Nhận Được x7 Tiền Cược!`
                await Currencies.increaseMoney(senderID, parseInt(coins * 7));
            }
            else {
...
case "h3": {
            if(h3.includes(lastNumber) == true) {
                msg += `»Bạn Đã Thắng!\n»Số Cuối Mã GD Là: ${lastNumber}\n»Bạn Nhận Được x7 Tiền Cược!`
                await Currencies.increaseMoney(senderID, parseInt(coins * 7));
            }
            else {
...
case "h4": {
            if(h4.includes(lastNumber) == true) {
                msg += `»Bạn Đã Thắng!\n»Số Cuối Mã GD Là: ${lastNumber}\n»Bạn Nhận Được x7 Tiền Cược!`
                await Currencies.increaseMoney(senderID, parseInt(coins * 7));
            }
            else {
        ...
        case "h5": {
            if(h5.includes(lastNumber) == true) {
                msg += `»Bạn Đã Thắng!\n»Số Cuối Mã GD Là: ${lastNumber}\n»Bạn Nhận Được x7 Tiền Cược!`
                await Currencies.increaseMoney(senderID, parseInt(coins * 7));
            }
            else {
...
case "h6": {
            if(h6.includes(lastNumber) == true) {
                msg += `»Bạn Đã Thắng!\n»Số Cuối Mã GD Là: ${lastNumber}\n»Bạn Nhận Được x7 Tiền Cược!`
                await Currencies.increaseMoney(senderID, parseInt(coins * 7));
            }
            else {
...
case "h7": {
            if(h7.includes(lastNumber) == true) {
                msg += `»Bạn Đã Thắng!\n»Số Cuối Mã GD Là: ${lastNumber}\n»Bạn Nhận Được x7 Tiền Cược!`
                await Currencies.increaseMoney(senderID, parseInt(coins * 7));
            }
            else {
...
case "h8": {
            if(h8.includes(lastNumber) == true) {
                msg += `»Bạn Đã Thắng!\n»Số Cuối Mã GD Là: ${lastNumber}\n»Bạn Nhận Được x7 Tiền Cược!`
                await Currencies.increaseMoney(senderID, parseInt(coins * 7));
            }
            else {
...
case "h9": {
            if(h9.includes(lastNumber) == true) {
                msg += `»Bạn Đã Thắng!\n»Số Cuối Mã GD Là: ${lastNumber}\n»Bạn Nhận Được x7 Tiền Cược!`
                await Currencies.increaseMoney(senderID, parseInt(coins * 7));
            }
            else {
