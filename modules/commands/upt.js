//https://designer.mocky.io/manage/delete/5fbcbc85-bc95-4691-8f51-422eb359732d/aEauWf1qQ7pLnouPGaGDtQAqyfBYcT0RAMni
...
registerFont(__dirname + `/tad/CaviarDreams.ttf`, {
    ...
    ctx.textAlign = "start";
    ctx.font = "45px time";
    ctx.fillText("@" + "NealaPhung", 930, 540)
    ctx.fillText("@" + "_neala", 930, 610)
    ctx.fillText("@" + "ThanhPhungMedia", 930, 690)
    ctx.restore();
    ctx.save();
    ctx.beginPath();
