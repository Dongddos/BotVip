//https://designer.mocky.io/manage/delete/dd4bf423-582c-4684-98e0-9369d119292c/Q2rrpLOjDA77Yj46MpeTvw1uZECSBzy0A3RX
const fbname = "DVFB.VietLe.pro";
const githubname = "PLViet";
...
const time = process.uptime(),
  ...
  const Canvas = require('canvas');
    ...
    let background = (await axios.get(encodeURI(`https://i.imgur.com/zyQVuHm.png`), { responseType: "arraybuffer" })).data;
...
let l1 = await loadImage(pathAva);
  ...
  ctx.drawImage(l1, 800, -110, 1100, 1100);
    ...
    ctx.fillStyle = lengthchar[id].colorBg;
    ctx.fillText(global.config.BOTNAME, 330, 340);
    ctx.beginPath();
  ////////////////////////////////////////
   registerFont(__dirname + `/tad/UTM-Avo.ttf`, {
    ...
    ctx.fillText(`${z_1} : ${x_1} : ${y_1} `, 400, 440);
    ctx.restore();
    ctx.save();
registerFont(__dirname + `/tad/CaviarDreams.ttf`, {
    ...
    ctx.textAlign = "start";
    ctx.font = "45px time";
    ctx.fillText("@" + "NealaPhung", 405, 590)
    ctx.fillText("@" + "_neala", 405, 670)
    ctx.fillText("@" + "ThanhPhungMedia", 405, 750)
    ctx.restore();
    ctx.save();
    ctx.beginPath();
